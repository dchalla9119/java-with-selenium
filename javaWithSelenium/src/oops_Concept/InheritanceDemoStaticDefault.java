...
interface BankATM12//by default every interface becomes abstract. if you declare or dont declare abstract there is no problem.
...
//	}
//}
abstract class BankATMImpl12 implements BankATM12//this is also correct. we can do it in another way
...
class BankATMImplOne12 extends BankATMImpl12//we can create object for this fully implemented class
{
	public void cashDeposit() {
		System.out.println("CASH DEPOSIT");
	}
...
public class InheritanceDemoStaticDefault {
...
//by using abstract method
	BankATMImpl12 bankATMImp11 = new BankATMImplOne12();
...
//by using interface reference
	BankATM12 bankATM1 = new BankATMImplOne12();
	bankATM1.balanceEnq();
	...
	BankATM12.accountCreation(); //static method
