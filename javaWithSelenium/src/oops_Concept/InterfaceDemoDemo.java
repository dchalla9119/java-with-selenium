...
interface BankATM11//by default every interface becomes abstract. if you declare or dont declare abstract there is no problem.
...
//	}
//}
abstract class BankATMImpl11 implements BankATM11//this is also correct. we can do it in another way
...
class BankATMImplOne11 extends BankATMImpl11//we can create object for this fully implemented class
{
	public void cashDeposit() {
		System.out.println("CASH DEPOSIT");
	}
...
public class InterfaceDemoDemo {
...
//by using abstract method
	BankATMImpl11 bankATMImp11 = new BankATMImplOne11();
...
//by using interface reference
	BankATM11 bankATM1 = new BankATMImplOne11();
	bankATM1.balanceEnq();
	...
	BankATM11.accountCreation(); //static method
