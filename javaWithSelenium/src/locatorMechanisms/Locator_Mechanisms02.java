...
public class Locator_Mechanisms02 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();//this is by using RemoteWebDriver. this is second approach. this method id is advisable
		...
		driver.get("http://demo.guru99.com/test/newtours/");//to enter the url
...
//		userClassName.click();
		//WebElement userClassName=driver.findElement(By.className("whsOnd zHQkBf"));
		
		//by using linkText
		//driver.findElement(By.linkText("REGISTER")).click();
		//WebElement userLinkText=driver.findElement(By.linkText("REGISTER")).click();
