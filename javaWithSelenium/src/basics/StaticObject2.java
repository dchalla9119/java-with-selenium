...
public static void main(String[] args) {
	Addition_Program2 NewProg = new Addition_Program2();//we created object with new operator. one object is going to be created along with static copy.
